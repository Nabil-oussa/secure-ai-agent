...
# 4. Tool read_file
@tool
def read_file(path: str, identity: str) -> str:
    """Lit un fichier dans le répertoire autorisé.

    Args:
        path: Chemin du fichier à lire.
        identity: Identité de l'agent qui demande l'accès.
...
# 5. Tool read_file
@tool
def delete_file(path: str, identity: str) -> str:
    """Supprime un fichier dans le répertoire autorisé.

    Args:
        path: Chemin du fichier à supprimer.
        identity: Identité de l'agent qui demande la suppression.
